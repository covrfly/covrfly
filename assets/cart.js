...
/* Ajuste minimalista en títulos de variantes */
document.addEventListener('DOMContentLoaded', () => {
  document.querySelectorAll('.product-option').forEach(option => {
    ...
    if(dt && dd) {
      if(dt.textContent.includes('Elige tu Modelo')) {
        dt.textContent = ''; 
        dd.textContent = dd.textContent.trim();
      }

      if(dt.textContent.includes('MagSafe')) {
        if(dd.textContent.trim().toLowerCase() === 'sí') {
          dt.textContent = ''; 
          dd.textContent = 'con MagSafe';
        } else {
